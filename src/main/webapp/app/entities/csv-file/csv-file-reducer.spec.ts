...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './csv-file.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CSVFILE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CSVFILE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CSVFILE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_CSVFILE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_CSVFILE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CSVFILE actions', async () => {
      const arg = 42666;
